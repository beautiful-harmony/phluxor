...
class Config
{
    ...
    public function __construct(
        ...
        private MeterProviderInterface|null $metricsProvider = null,
    ) {
    }
    ...
    public function diagnosticsSerializer(): Closure
    {
        ...
        return static fn (ActorInterface $actor): string => '';
    }
    ...
    public function metricsProvider(): MeterProviderInterface|null
    {
